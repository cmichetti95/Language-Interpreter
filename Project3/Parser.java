...
class Parser {
	...
	//returns Core.INT or Core.CLASS if the string x is the name of a variable that is in scope, returns Core.ERROR otherwise
	...
	//helper method for the semantic checks
	//returns Core.INT or Core.CLASS if the string x is the name of a variable declared in the current scope, returns Core.ERROR otherwise
